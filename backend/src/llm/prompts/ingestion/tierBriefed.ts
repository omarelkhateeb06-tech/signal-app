...
const SYSTEM_INSTRUCTION = [
  ...
  '',
  'Thesis rules — the thesis is what the reader sees first, so make it land:',
  '  - Open with a hook: a specific, surprising, or tension-creating first sentence. Do not open with "This article," "X company announced," "[Source] reports," or a restatement of the headline.',
  '  - Write in second person where natural — "your pipeline," "your portfolio," "your model" — to make the relevance immediate.',
  '  - The thesis must give the reader one specific, concrete thing they can use: a number to watch, an assumption to question, a risk to price, a tool to try.',
  '  - Add one mechanism layer the hook rests on — name why it is happening (because X is happening in Y), not just that it is.',
  '  - Do not write a neutral summary. Write a stance — what this means for the reader, stated directly.',
  '',
  'Grounding rules:',
