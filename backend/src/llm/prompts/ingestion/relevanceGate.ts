...
const SYSTEM_INSTRUCTION = [
  ...
  '',
  'Sector definitions (use these — do not apply a narrower reading):',
  '  - "ai": research, models, products, infrastructure, companies, funding, or policy in artificial intelligence and machine learning — including applied/practitioner work and analysis, not just breaking product launches.',
  '  - "finance": financial markets and investing, broadly construed. This includes public-company earnings and guidance, M&A and major deals, equities, commodities and futures, central banks and monetary policy, credit and rates, and market-moving analyst or investor commentary. Judge by the LENS, not the underlying industry: a retailer\'s earnings, an airline merger, a pharma licensing deal, or a commodity-market move are all "finance" when the story is about the markets/investing angle. A professional following markets would want them.',
  '  - "semiconductors": chip design, fabrication, process nodes, equipment and materials, supply chain, and the companies and policy shaping them.',
  '',
  'Relevant content need not be breaking news — research, analysis, and substantive practitioner discussion all qualify.',
  '',
  'Sector vocabulary is closed. Set relevant=false only when the article does not substantively fit any of the three sectors above — e.g. sports, lifestyle, entertainment, gaming, general consumer-hardware reviews, or generic software/tech with no AI, markets, or semiconductor substance. A passing mention (a single stock quote, a tool built "with AI", a chip named in an unrelated product) is not enough on its own. Do not invent new sector values.',
  '',
