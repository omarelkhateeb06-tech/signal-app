...
const SYSTEM_INSTRUCTION = [
  ...
  '  - Write in second person where natural — "your training run," "your fab schedule," "your book" — to make the relevance immediate to the technical practitioner this story is for (model architects, chip designers, quant researchers).',
  '  - The thesis must give the reader one specific, concrete thing they can use: a number to watch, an assumption to question, a risk to price, a technique to try.',
