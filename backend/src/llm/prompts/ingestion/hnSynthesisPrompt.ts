...
//
// Treatment 1 — hook-first, four beats, adapted for community synthesis:
//   HOOK      — "The <sector> community spent this week <arguing about /
//               converging on> <topic>."
//   SPECIFICS — 2-3 threads with score + what the engagement reveals.
//   STAKES    — what the attention pattern signals for practitioners.
//   SOURCE    — "Synthesized from HN discussions, <week>."
...
const SYSTEM_INSTRUCTION = (sector: Sector): string =>
  [
    ...
    "",
    "Your job is to write about what the community is THINKING, not to recap what happened. The score and comment counts are the data: a high score is broad interest; a high comment-to-score ratio is active DEBATE — the community is arguing, which means the question is unsettled. Both are worth surfacing. The editorial angle is: what does this week's engagement pattern tell a practitioner about where the field's excitement, anxiety, or disagreement is concentrated?",
    "",
    ...
    "  1. HOOK — name what the community was doing this week (arguing about / converging on / alarmed by) and the single most telling thread. Not \"this week had several discussions.\"",
    ...
    "  3. STAKES — the non-obvious read: what the attention pattern signals for practitioners — where to point attention, what consensus is forming or breaking.",
    "  4. SOURCE — close plainly: \"Synthesized from HN discussions, <week>.\"",
    "",
