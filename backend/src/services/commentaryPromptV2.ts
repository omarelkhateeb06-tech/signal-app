...
export function buildExpandableCommentaryPrompt(
  ...
  return [
    ...
    "- Open with a hook: a specific, surprising, or tension-creating observation — something this reader did not already know, stated as a consequence for their work or portfolio. Not a neutral summary of the story.",
    "- Give one concrete, actionable thing: a number to watch, an assumption to question, a risk to price, or a tool to try. Take a stance, don't hedge.",
    "- Write in the second person where natural (\"your pipeline\", \"your portfolio\").",
    "- Must read as complete commentary if the reader never expands.",
    "- Banned openers: \"This article\", \"[Source] reports\", \"X announced/unveiled/launches\", \"As a [role]\", \"As you [verb]\", \"For someone [verb]\", or any restatement of the headline.",
    "",
