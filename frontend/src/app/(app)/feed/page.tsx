...
export default function FeedPage(): JSX.Element {
  ...
  return (
    <div className="space-y-14 pb-16 pt-2">
      ...
      {/* ===== The ranked river with editorial RHYTHM =====
          The old Top Stories text strip is gone — those stories merge into
          the river as featured (wide) cards. The river alternates between
          wide feature cards and standard 3-col rows, with breathing room
          between clusters, so the scroll never becomes wallpaper. */}
      {(() => {
        // Merge leftover rail items (#4-6) into the front of the river
        // so the whole thing is one continuous ranked flow.
        ...
        // Chunk the river into clusters: a FEATURE card (wide, 2-col span)
        // then a batch of STANDARD cards (3-col row). Every 4th item is a
        // feature, the rest are standard — this gives the rhythm.
